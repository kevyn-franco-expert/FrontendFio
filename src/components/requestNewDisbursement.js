  ...
  return (
    <>
      ...
      <Container maxW="8xl">
        ...
        {data.account_data.capital_requested !== 0 && <Text>Monto solicitado pendiente de aprobacion: <Badge fontSize='lg' pt={1}  colorScheme='yellow'>S/ {data.account_data.capital_requested}</Badge></Text>}
